        ...
        >
          {isDashboardPage ? (
            ...
            <main className="flex-1 flex flex-col h-screen overflow-hidden bg-white dark:bg-gray-900">
              {/* Header */}
              <header className="flex justify-between items-center bg-white dark:bg-gray-900 p-4 md:p-6 shadow-lg relative border-b border-gray-200 dark:border-gray-700">
                {/* Mobile layout */}
                ...
                <div className="hidden md:flex justify-between items-center w-full">
                  ...
                  <nav className="flex space-x-8 text-lg text-gray-800 dark:text-gray-300 font-medium relative">
                    {navItems.map(({ label, path }) => {
                      const isActive =
                        pathname === path || (label === "HOME" && pathname === "/");
